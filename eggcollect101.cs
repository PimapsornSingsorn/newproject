...
namespace newproject
{
    public partial class eggcollect : Form
    {
        ...
        private void stock_egg() //แสดงจำนวนไข่ในคลัง
        {
            try
            {
        ...
        private void egg_collection()//ตารางเก็บไข่
        {
            try
            {
                MySqlConnection connection = databaseConnection();
        ...
        private void egg_stock() //บวกไข่ไปอัพเดทในคลัง
        {
            //ทำคละไซต์
        ...
        {
            amount_chic_txt.ResetText();
            amount_size0_txt.ResetText();
            amount_size1_txt.ResetText();
            amount_size2_txt.ResetText();
            amount_size3_txt.ResetText();
            amount_size4_txt.ResetText();
        }
